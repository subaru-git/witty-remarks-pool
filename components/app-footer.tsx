...
const AppFooter = () => {
  return (
    <div>
      <footer className="bg-gray-700 h-32 pt-4">
        <div className="flex flex-col justify-between h-full">
          <div className="mx-auto w-max">
            <p className="bg-clip-text text-transparent bg-gradient-to-r from-gray-300 to-white font-serif text-2xl italic tracking-wider">
              Witty Remarks Pool
            </p>
          </div>
          <div className="flex-none w-max mx-auto">
            <a
          ...
          <div className="flex-initial bg-gray-800 w-full p-1">
            <div className="w-max mx-auto">
              <p className="copyright text-gray-100 ">
                &copy; 2021 subaru-git{" "}
              </p>
            </div>
          </div>
        </div>
